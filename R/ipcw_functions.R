# PROGRAM:    ipcw_functions.R                                                   
# PURPOSE:    Functions for inverse probability of censoring weights. Includes:
#   convert_to_long:   convert data to long to prep for pooled logistic IPCW model
#   icpw:              ipcw function to estimate weights based on user-supplied 
#                      model form and add to data frame
#   compare_cumul_inc: function to estimate naive and weighted  cumulative 
#                      incidence curves and return simple plots. 
# PROGRAMMER: C Wiener
